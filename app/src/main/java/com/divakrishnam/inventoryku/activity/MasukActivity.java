...
public class MasukActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MasukActivity.this, FormMasukActivity.class));
            }
        });
    ...
    private void loadData() {
        showLoading(true);
        Call<ResponseMasuk> call = apiService.getMasuk();
        call.enqueue(new Callback<ResponseMasuk>() {
            @Override
            public void onResponse(Call<ResponseMasuk> call, Response<ResponseMasuk> response) {
                List<Masuk> list = response.body().getData();
                adapter = new MasukAdapter(list);
